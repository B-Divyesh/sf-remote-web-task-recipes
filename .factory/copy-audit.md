...
filled sample action, its immediate result, and three short facts. The header
download link is outlined. No item below is over 22 words or uses a banned
marketing word.
...
| L04 | 1 | Demo | — |
| L05 | 1 | Privacy | — |
| L06 | 2 | Download extension | Outlined navigation link |
...
| L10 | 5 | Try it with sample data | Filled first-screen action |
