...
async function init() {
  ...
  if (!recipes.length) { status.textContent = 'No notebook for this app yet.'; tasks.innerHTML = '<p class="empty-popup">Open the editor to map its first landmark.</p>'; return; }
